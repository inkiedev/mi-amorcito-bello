...
export function RomanticBanner() {
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-primary/20 via-secondary/30 to-accent/20 rounded-2xl p-8 mb-8 romantic-particles hover-glow">
        ...
        <div className="mt-6">
          <Card className="inline-block px-8 py-4 bg-gradient-to-r from-accent/20 to-primary/20 border-accent/30 animate-romantic-glow">
            <p className="text-2xl font-bold text-primary animate-pulse-heart">
              💕 {Math.floor((Date.now() - new Date("2024-10-25").getTime()) / (1000 * 60 * 60 * 24))} días de amor puro
              💕
            </p>
          </Card>
        </div>
